...
import { getRootProxyHandlerFactory, setRootProxyHandlerFactory } from '@geajs/core/ssr'
...
if (!getRootProxyHandlerFactory()) {
  setRootProxyHandlerFactory(createSSRRootProxyHandler)
}
